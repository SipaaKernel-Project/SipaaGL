...
namespace SipaaGL
{
    ...
    public unsafe class Graphics : IDisposable
    {
        ...
        public void DrawString(int X, int Y, string Text, BitFont Font, Color Color, bool Center = false)
        {
            // Basic null check.
        ...
        public int DrawChar(int X, int Y, char Char, BitFont Font, Color Color, bool Center)
        {
